...
\begin{proof}
    ...
    \begin{itemize}
       ...
       Si $j+1 \leq i \leq n$, entonces $k_x < \frac{1}{2}m_{j+1} \leq \frac{1}{2}m_i$, luego $\frac{k_x}{m_i} \leq \frac{1}{2}$ y por tanto
        ...
        \end{aligned}\]
        Como $j \leq n-\sqrt{n}$, entonces $n-j \geq \sqrt{n}$ y por tanto $\lim_{n\to\infty}(n-j) = \infty$. Usando esto y el \hyperref[2.2.11]{\color{blue}Lema 2.2.11}, 
        ...
        \]
        utilizándose que $\phi_n$ es un polinomio trigonométrico no negativo de grado $m_0 \leq k_x$. Con esto queda probado \hyperref[2.2.16]{\color{blue}(2.2.16)}.
        \item \textit{Si $n$ es suficientemente grande, para todo $x \in \bigcup_{j=0}^{2n}I_j'$ se verifica \begin{equation}\label{2.2.17}
